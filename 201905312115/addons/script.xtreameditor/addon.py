...
class MainWindow(xbmcgui.WindowXML):
    ...
    CHANNELS_PER_PAGE = 9
    #
    APIURL = 'http://xtream-editor.com/app/'
    #
    XSERVER = 'http://xtream-editor.com'
    APPVERSION = XSERVER+'/e2/get/appversion'
    ...
    def setPVRSettings(self):
        ...
        #pvr.setSetting('epgCache',"false") 
        #pvr.setSetting('m3uCache',"false") 
    ...
    def initApp(self):
        ...
        try:
            ...
            r = urllib.urlopen(self.APPCODEURL,params)
            if (r.getcode() == 200):
                jsondata = r.read()
    ...
    def getSettings(self):
        ...
        try:
            params = urllib.urlencode({'version': self.VERSION})
            r = urllib.urlopen(self.SETTINGSURL+self.xappcode,params)
            if r.getcode() == 200:
                jsondata = r.read()
                d = json.loads(jsondata)
                ...
                if self.lineid != '0':                        
                    ...
                    dialog.notification('XTREAM EDITOR', addon.getLocalizedString(50004),xbmcgui.NOTIFICATION_WARNING, 5000)
        ...
        try:
            ...
            self.lineid = result["lineid"]
            self.m3uurl = result["m3u"]
            self.epgurl = result["epg"]
